<?php
	class recherche extends Controller {  // Le nom de la classe est le nom du controller avec une majuscule
		...
		*/
		...
		$donnees = $this->Model_recherche->recherche_simple($requete_patro.' AND a.départment = "Aube"');
		...
		*/
		...
		$donnees = $this->Model_recherche->recherche_simple($requete_region.'AND a.départment = "Aube"');
		...
		*/
		...
		$donnees = $this->Model_recherche->recherche_simple($requete_fief.'AND a.départment = "Aube"');
		...
		*/		
		...
		$donnees = $this->Model_recherche->recherche_simple($requete_siecle.'AND a.départment = "Aube"');
		...
		*/
		...
		$donnees1 = $this->Model_recherche->recherche_simple2($requete1.'AND a.départment = "Aube" AND l.départment = "Aube" ORDER BY length(a.blasonnement_1)');
		$donnees2 = $this->Model_recherche->recherche_simple2($requete2.'AND a.départment = "Aube" AND l.départment = "Aube" ORDER BY length(a.blasonnement_2)');
		}
		}
		/*
		|----------------------------------------------------------------------------------------------------
