...
<a href="<?php echo PALISEP ; ?>" ><img src="<?php echo base_url()?>ressources/images/palisep.png"  style="height:35px; margin-bottom: 0px; margin-left:382px; border: none; "></a>
<br/>
<br/>
<center>
...
<!-- Si l'admin est connecté -->
	<?php header("Location: ".base_url()); ?> <?php } ?>
</div>
