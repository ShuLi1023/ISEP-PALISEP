...
class Model_legende_photos extends Model{ 
	// Le nom de la classe est le nom du model avec une majuscule

	function infos($id){
		$donnees = $this->db->query('
			SELECT l.id, l.libellé_image, l.vedette_chandon , l.auteur_cliché, l.type_cliché, l.année_cliché, l.pays, l.région, l.départment, l.commune, l.village, l.edifice_conservation, l.emplacement_dans_édifice, 
					...
					l.titre, l.catégorie, l.matériau, l.ref_reproductions, l.biblio, l.auteurs, l.lieu_édition, l.editeur, l.année_édition, l.reliure, l.provenance, l.site, l.section, l.cote, l.folio_emplacement
...
*/
	function recherche_photo($requete){ // la fonction fiche() est utilisée dans le controller fiche.php
		$donnees = $this->db->query('
			SELECT DISTINCT l.famille, l.id, l.libellé_image, l.vedette_chandon , l.auteur_cliché, l.type_cliché, l.année_cliché, l.commune, l.village, l.edifice_conservation, l.emplacement_dans_édifice,
					l.photo, l.commune_INSEE_number, l.ref_IM, l.ref_PA, l.ref_IA, l.artificial_number_Decrock, l.individu, l.qualité, l.date, l.dénomination,
					l.titre, l.catégorie, l.matériau, l.ref_reproductions, l.biblio
			FROM legende_photos l, armorial a
			WHERE '.$requete.'
		');
