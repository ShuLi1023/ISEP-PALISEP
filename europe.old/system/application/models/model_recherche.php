...
function recherche_simple2($requete){ 
    ...
    function departement_liste(){ // la fonction fiche() est utilisée dans le controller fiche.php
		$donnees = $this->db->query('
    ...
    function region_liste(){ // la fonction fiche() est utilisée dans le controller fiche.php
		$donnees = $this->db->query('
    ...
    function pays_liste(){ // la fonction fiche() est utilisée dans le controller fiche.php
		$donnees = $this->db->query('
