	...
	<tr rules="rows">
		...
		<?php foreach($photos as $photo){ 
			if ($photo->vedette_chandon == $data1->patronyme){ ?>
				...
				<a href="<?php echo PALISEP ; ?>ressources/images/<?php echo $photo->libellé_image; ?>.jpg" rel="lightbox[roadtrip]">
					<img height="100px" src="<?php echo PALISEP ; ?>ressources/images/<?php echo $photo->libellé_image; ?>.jpg"/>
				</a>
			<?php } 
		} ?> 
		</td>
