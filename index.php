	...
	<div class="images">
		...
		<a href="heraldique">
			<div class="text" style="top: 75%; left: 25%;">
				L‘héraldique recense des armoiries européennes sous forme de blasonnements, fruit de dépouillements multiples (env. 198 000 entrées).
			</div>
		</a>
	</div>
	<div class="images">
		...
		<a href="livre2">
			<div class="text" style="top: 25%; left: 75%;">
				L‘héraldique et le livre publie des notices sur les fers de reliure et les présences héraldiques ou emblématiques sur 
