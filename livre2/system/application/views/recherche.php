...
<?php // if(!isset($_POST['rechercher_ordre']) && !isset($_POST['rechercher_desordre']) && !isset($_POST['rechercher_patronyme']) && !isset($_POST['rechercher_region'])&& !isset($_POST['rechercher_fief'])&& !isset($_POST['rechercher_departement'])&& !isset($_POST['rechercher_siecle']) && !isset($_POST['rechercher_siecle2']) && !isset($_POST['recherche_id'])){  //condition formulaire?> 
...
<fieldset>
  ...
  <form action="recherche" method="post">	
	...
	<input type="text" name="cimiers" <?php if (isset($_POST['cimiers'])){ ?>value="<?php echo $_POST['cimiers'] ;?>"<?php }; ?>/><br /><br />
	...
	<input type="text" name="pays"  <?php if (isset($_POST['pays'])){ ?>value="<?php echo $_POST['pays'] ;?>"<?php }; ?>/><br /><br />
	...
	<input type="text" name="devise" <?php if (isset($_POST['devise'])){ ?>value="<?php echo $_POST['devise'] ;?>"<?php }; ?>/><br /><br />
