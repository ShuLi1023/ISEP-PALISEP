...
function ConfirmMessage($id) {
       if (confirm("Etes-vous sûr de vouloir supprimer?")) { // Clic sur OK
          window.location = "<?php echo base_url(); ?>administration?anc_onglet=contenus&lc=a&ids="+$id;
       }
   }
...
$(document).ready(function(){
  ...
  <body>
    ...
    <div id="bibliotheque_accueil">
      <div id="wrapper">
	
	<!-- Bouton de déconnexion -->
	<?php if ($connecte == true){ ?>	
	<div style="width:940px; margin-top:5px; position:relative; z-index:50; margin-left: auto; margin-right: auto;">
	  <form action="administration" method="POST">
	    <input style="right:0; position:absolute;"type="submit" name="deconnexion" value="Deconnexion" id="deconnexion" /> 
	  </form>
	</div>
	<?php }	?>      
	<div id="header">
	  <center>
	    <div id="logo">
	      <a href="<?php echo base_url()?>">
			<img style="margin-top:50px;margin-right:40px;" src="<?php echo base_url()?>resources/images/livre1-grand.png" id="aube"/>
	      </a>
	    </div>
	  </center>
	</div>
