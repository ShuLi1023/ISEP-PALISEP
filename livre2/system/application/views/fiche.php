...
<a href="<?php echo base_url()?>details/photos/<?php echo $photo->id; ?>">
<img height="80px" src="<?php echo PALISEP ; ?>resources/images/<?php echo $photo->libelle_image; ?>.jpg"/>
</a>
...
$i=0;?>
	...
	<div class="fiche">
		<div style="float:left;margin-left:2%; width:40%;text-align: justify;">
			...
			<strong>Département</strong>: <?php echo $data->departement; ?> <br /><br />
			<strong>Région</strong>: <?php echo $data->region; ?> <br /><br />
			...
			<div style="float:right;margin-right:2%; width:40%;text-align: justify;">
