...
class Model_legende_photos extends Model{ // Le nom de la classe est le nom du model avec une majuscule
	...
	function infos($id){
		$donnees = $this->db->query('
			SELECT l.id, l.libellé_image, l.vedette_chandon , l.auteur_cliché, l.type_cliché, l.année_cliché, l.région, l.départment, l.commune, l.village, l.edifice_conservation, l.emplacement_dans_édifice, 
