...
<div id="wrapper">
	...
	<div id="header">
		<div id="logo">
		<a href="<?php echo base_url()?>" ><img src="<?php echo base_url()?>ressources/images/laube.png" id="aube"></a>
		<a href="/palisep/" ><img src="<?php echo base_url()?>ressources/images/palisep.png" id="palisep"></a>
	</div>
	</div>
		<!-- Onglets -->
			<div id="menu">
