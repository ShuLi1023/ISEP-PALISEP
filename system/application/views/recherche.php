...
if(isset($_POST['rechercher_desordre']) || isset($_POST['rechercher_ordre'])){ ?>
		<h4><a href="javascript:history.go(-1)"><<< Retour sur le formulaire</a></h4>
	...
	<tr rules="rows">
		...
		<?php foreach($photos as $photo){ 
			if ($photo->vedette_chandon == $data1->patronyme){ ?>
				...
				<a href="<?php echo base_url()?>ressources/images/<?php echo $photo->libellé_image; ?>.jpg" rel="lightbox[roadtrip]">
					<img height="100px" src="<?php echo base_url()?>ressources/images/<?php echo $photo->libellé_image; ?>.jpg"/>
				</a>
			<?php } 
		} ?> 
		</td>
...
<br /> <br /> 
<!-- PATRONYME-->
<fieldset style="float:left;margin-left:7%;">
...
<fieldset style="float:right;margin-right:7%">
...
<fieldset style="float:left;margin-left:14.5%">

		<legend><strong> Recherche par Armes</strong></legend>
	<form action="recherche" method="post">	
	<label class="label2"><strong>Armes</strong></label>
		<input type="text" name="mot" size="85%" <?php if (isset($_POST['mot'])){ ?>value="<?php echo $_POST['mot'] ;?>"<?php }; ?>/><br /><br />
	<div style="margin-left:10%">
	<label style="float:left;width:110px">Patronyme</label>
		<input style="float:left" type="text" name="mot_2"  <?php if (isset($_POST['mot_2'])){ ?>value="<?php echo $_POST['mot_2'] ;?>"<?php }; ?>/>
	<label style="margin-left:10px;float:left;width:110px;">Département</label>
		<input type="text" name="mot_5"  <?php if (isset($_POST['mot_5'])){ ?>value="<?php echo $_POST['mot_5'] ;?>"<?php }; ?>/><br /><br />
	<label style="float:left;width:110px;">Fief / Communes</label>
		<input  style="float:left" type="text" name="mot_4"  <?php if (isset($_POST['mot_4'])){ ?>value="<?php echo $_POST['mot_4'] ;?>"<?php }; ?>/>
	<label style="margin-left:10px; float:left;width:110px;">Région</label>
	...
	<label style="float:left;width:110px;">Siècle</label>
		<select style="float:left" name="mot_6">
			<option value=""> </option>
	 ...
	 <label style="margin-left:10px; float:left;width:100px;" >Dénomination</label>
		...
		<div style="margin-left:15%;">
			<div id="ordre" style="float:left">
				...
				<a href="javascript:affichage('desordre','ordre');"><img style="border: none" src="<?php echo base_url()?>ressources/images/echange.jpg" width="18px"/></a>
			</div>
			<div id="desordre" style="visibility:hidden;float:left">
				<a href="javascript:affichage('ordre', 'desordre');"><img style="border: none" src="<?php echo base_url()?>ressources/images/echange.jpg" width="18px"/></a>
