	...
	<?php foreach($donnees as $data) { ?>
		...
		<td align="right" >
				<a href="<?php echo base_url()?>ressources/images/<?php echo $data->libellé_image; ?>.jpg" rel="lightbox[roadtrip]">
					<img height="100px" src="<?php echo base_url()?>ressources/images/<?php echo $data->libellé_image; ?>.jpg"/>
				</a>
		</td>
		</tr>			 		 		 		 		 		 		 		 		 		 		 		 		 		
	<?php 
...
<!-- MATERIAU-->
		...
		<input type="text" name="mot" size="50px"<?php if (isset($_POST['mot'])){ ?>value="<?php echo $_POST['mot'] ;?>"<?php }; ?>/>
		</div>
		<br /><br />
		</div>	
